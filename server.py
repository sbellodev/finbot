        ...
        if updates:
            for item in updates:
                ...
                if message == "help":
                    ...
                    bot.send_message(coin_reply(base_url+coin_doge), from_)
                elif message == "all":
                    all_coins = coin_reply(base_url+coin_btc) + "\n\n" +  coin_reply(base_url+coin_iot) + "\n\n" +  coin_reply(base_url+coin_doge)
